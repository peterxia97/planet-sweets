...
export const CAKE_DESCRIPTIONS: Record<number, { zh: string; en: string }> = {
  1301: { zh: '南瓜奶酪泥+奶冻，搭配混合坚果，营养丰富口感层次高。', en: 'Pumpkin cheese paste + panna cotta with mixed nuts, rich in nutrition and texture.' },
  1302: { zh: '黄油薄脆+焦糖海盐奶油+拿铁奶冻+咖啡戚风。浓郁咖啡香融入绵密蛋糕体，层层夹入顺滑奶油，表面淋上琥珀色焦糖酱，是属于大人的温柔甜点。', en: 'Butter crisp + salted caramel cream + latte panna cotta + coffee chiffon. Rich coffee aroma infused in soft cake layers with silky cream, topped with amber caramel sauce.' },
  ...
  201: { zh: '夹心：特调红茶奶油+红茶奶冻', en: 'Filling: black tea cream + tea panna cotta' },
  202: { zh: '夹心：抹茶奶油+抹茶奶冻', en: 'Filling: matcha cream + matcha panna cotta' },
  203: { zh: '夹心：桂花酱+桂花奶冻', en: 'Filling: osmanthus jam + osmanthus panna cotta' },
  ...
  207: { zh: '夹心：香蕉泥+焦糖奶冻', en: 'Filling: banana puree + caramel panna cotta' },
  208: { zh: '夹心：奶冻+开心果碎', en: 'Filling: panna cotta + crushed pistachios' },
  209: { zh: '因珍珠特性建议当天食用完', en: 'Best consumed on the day due to pearls' },
  210: { zh: '夹心：巧克力奶冻+黄油薄脆', en: 'Filling: chocolate panna cotta + butter crisp' },
  ...
  802: { zh: '细腻奶冻夹心', en: 'Delicate panna cotta filling' },
  ...
  807: { zh: '伯爵红茶口味奶冻', en: 'Earl Grey flavored panna cotta' },
...
export const UI: Record<string, { zh: string; en: string }> = {
  ...
  'banner.tagline': { zh: 'Planet Sweets', en: 'Handmade Fresh Daily' },
